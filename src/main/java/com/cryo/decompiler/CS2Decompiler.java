...
import com.cryo.decompiler.ast.CommentNode;
import com.cryo.decompiler.ast.FunctionNode;
import com.cryo.decompiler.ast.LocalVariable;
...
public class CS2Decompiler {
	...
	public FunctionNode decompile(int id) throws DecompilerException {
		if (decompiling.contains(id)) {
			System.out.println("Stuck inside a loop?");
		...
		if (cs2 == null) {
			System.out.println("CS2 is null");
		...
		System.out.println("N: "+cs2.getName()+" ReturnType: "+cs2.getReturnType());
